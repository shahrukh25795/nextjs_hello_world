...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AboutUs, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var parased = queryString.parse(location.search);
      console.log(queryString.parse(prevProps.location.search)); // if (JSON.stringify(queryString.parse(prevProps.location.search)) !== JSON.stringify(parased)) {
      //     this.setState({
      //         filter: parased.site_admin ? parased.site_admin : false
      //     })
      // }
...
//# sourceMappingURL=aboutUs.js.c7dc4fd24535ad9b8374.hot-update.js.map